...
const (
	...
	MESSAGE_ROLE_ADMIN                     = "the role is not admin"
	MESSAGE_ROLE_SALES                     = "the role is not sales"
	MESSAGE_ROLE_OPS                       = "the role is not ops"
...
var (
	...
	ErrCreateCourseClientNotFound = errors.New("customer tidak ditemukan")
